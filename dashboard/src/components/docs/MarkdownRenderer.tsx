...
const components: Components = {
  ...
  a: ({ href, children }) => {
    ...
    return (
      <Link href={rewritten} className="text-orange-600 hover:text-orange-700 underline underline-offset-2">
        {children}
      </Link>
    );
  },
  ...
  blockquote: ({ children }) => (
    <blockquote className="border-l-4 border-orange-400 pl-4 py-1 my-4 text-gray-600 bg-orange-50/50 rounded-r">
      {children}
    </blockquote>
  ),
